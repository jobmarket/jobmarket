                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append">                                  
                            <input id="appendedInput" size="16" type="text"><span class="add-on">VND</span>
                        </div>                              
                    </div>                              
                </div>                                  
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-append">                                  
                            <input id="appendedInput" class="span2" size="16" type="text"><span class="add-on">Days</span>                                                          
                            <input id="appendedInput" class="span2" size="16" type="text"><span class="add-on">Monts</span>                                                                     
                            <input id="appendedInput" class="span2" size="16" type="text"><span class="add-on">Years</span>
                        </div>                              
                    </div>                              
                </div>                                  
            </div><!--Tag content-->
